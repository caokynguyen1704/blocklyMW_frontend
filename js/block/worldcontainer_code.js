...
Blockly.Lua['worldcontainer_addfurnace'] = function (block) {
	let axis_x = luaGenerator.valueToCode(block, 'AXIS_X', Blockly.Lua.ORDER_NONE);
	let axis_y = luaGenerator.valueToCode(block, 'AXIS_Y', Blockly.Lua.ORDER_NONE);
	let axis_z = luaGenerator.valueToCode(block, 'AXIS_Z', Blockly.Lua.ORDER_NONE);
...
Blockly.Lua['worldcontainer_setstorageitem'] = function (block) {
	...
	let axis_y = luaGenerator.valueToCode(block, 'AXIS_Y', Blockly.Lua.ORDER_NONE);
	let axis_z = luaGenerator.valueToCode(block, 'AXIS_Z', Blockly.Lua.ORDER_NONE);
	let offset = luaGenerator.valueToCode(block, 'OFFSET', Blockly.Lua.ORDER_NONE);
	let item_id = luaGenerator.valueToCode(block, 'ITEM_ID', Blockly.Lua.ORDER_NONE);
	let count = luaGenerator.valueToCode(block, 'COUNT', Blockly.Lua.ORDER_NONE);
