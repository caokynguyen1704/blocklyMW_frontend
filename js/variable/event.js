...
var EventData = {
	...
	'Block.Add': ['blockid', 'x', 'y', 'z'],
	'Block.DestroyBy': ['eventobjid', 'blockid', 'x', 'y', 'z'],
	'Block.Dig.Begin': ['eventobjid', 'blockid', 'x', 'y', 'z'],
	'Block.Dig.Cancel': ['eventobjid', 'blockid', 'x', 'y', 'z'],
	'Block.Dig.End': ['eventobjid', 'blockid', 'x', 'y', 'z'],
	'Block.Fertilize': ['eventobjid', 'blockid', 'x', 'y', 'z'],
	'Block.PlaceBy': ['eventobjid', 'blockid', 'x', 'y', 'z'],
	'Block.Remove': ['blockid', 'x', 'y', 'z'],
	'Block.Trigger': ['eventobjid', 'blockid', 'x', 'y', 'z'],
	'DropItem.AreaIn': ['eventobjid', 'areaid', 'itemid', 'itemnum'],
	'DropItem.AreaOut': ['eventobjid', 'areaid', 'itemid', 'itemnum'],
	'Item.Disappear': ['eventobjid', 'toobjid', 'itemid', 'itemnum'],
	'Item.Pickup': ['eventobjid', 'toobjid', 'itemid', 'itemnum'],
	'Missile.AreaIn': ['eventobjid', 'areaid', 'itemid', 'itemnum'],
	'Missile.AreaOut': ['eventobjid', 'areaid', 'itemid', 'itemnum'],
	'Missile.Create': ['eventobjid', 'toobjid', 'itemid', 'x', 'y', 'z'],
